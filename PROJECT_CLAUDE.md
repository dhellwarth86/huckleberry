...
| E | Backend API + frontend strip-and-connect (frontend stops parsing in browser; pulls structured data from backend; Phase 1 v6.3.x HTML preserved as offline fallback) | **NEXT-eligible** — UNBLOCKED by D.1 + D.2; persistence layer now in place |
