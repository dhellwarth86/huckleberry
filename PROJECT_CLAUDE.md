...
| E.2 | Frontend strip + connect (remove ~3,800–4,100 lines of backend-shaped JS per `E0_FRONTEND_AUDIT.md`; consume API; preserve viewer + tools + takeoff Excel; v6.3.x HTML preserved in safe_for_removal as offline fallback reference) | **NEXT-eligible** — soft gate, drafted after Daniel reviews E.1 deliverables |
